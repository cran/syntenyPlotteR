...
This package has been developed by Joana Damas ([joanadamas\@gmail.com](mailto:joanadamas@gmail.com){.email}), Sarah Quigley ([slq4\@kent.ac.uk](mailto:slq4@kent.ac.uk){.email}), Denis Larkin ([dlarkin\@rvc.ac.uk](mailto:dlarkin@rvc.ac.uk){.email}) and Marta Farré ([m.farre-belmonte\@kent.ac.uk](mailto:m.farre-belmonte@kent.ac.uk){.email})
...
![](vignettes/images/example.deshrambler.output.png){width="333"}
...
![](vignettes/images/example.alignment.input.png){width="521"}
...
## ![](vignettes/images/example.lengths.input.png){width="263"}
...
The function outputs a text file containing the reformatted alignment data
As default the function saves the file to a temporary directory, this can be overridden using the `directory` parameter i.e. `directory = "path/to/directory"`. 
...
## ![](vignettes/images/example_eh.png){width="200" height="400"}
...
![](vignettes/images/example.ideogram.png){width="320"}
...
![](vignettes/images/example_linear.png){width="519"}
